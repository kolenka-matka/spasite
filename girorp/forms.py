...
class MoviesChoiceForm(forms.Form):
    ...
    exclude_games_indie = forms.BooleanField(label='исключить: инди', required=False)
    exclude_games_action = forms.BooleanField(label='исключить: экшен', required=False)
    exclude_games_adventure = forms.BooleanField(label='исключить: приключение', required=False)
    exclude_games_casual = forms.BooleanField(label='исключить: казуальная игра', required=False)
    exclude_games_simulation = forms.BooleanField(label='исключить: симулятор', required=False)
    exclude_games_rpg = forms.BooleanField(label='исключить: ролевая игра', required=False)
    exclude_games_strategy = forms.BooleanField(label='исключить: стратегия', required=False)
    exclude_games_singleplayer = forms.BooleanField(label='исключить: для одного игрока', required=False)
    exclude_games_early_access = forms.BooleanField(label='исключить: ранний доступ', required=False)
    exclude_games_free_to_play = forms.BooleanField(label='исключить: бесплатная игра', required=False)
    exclude_games_twod = forms.BooleanField(label='исключить: 2D', required=False)
    exclude_games_atmospheric = forms.BooleanField(label='исключить: атмосферная', required=False)
    exclude_games_threed = forms.BooleanField(label='исключить: 3D', required=False)
    exclude_games_massively_multiplayer = forms.BooleanField(label='исключить: ММО', required=False)
